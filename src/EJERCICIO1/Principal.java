...
public class Principal {
	...
	public static void main(String[] args) {
		...
		vecEmpleados[1] = new Empleado("45000111", "Brunaco", "Fondati", LocalDate.of(2000, 4, 25), 
				   "Masculino", "Bruno@gmail.com", "calle 456", "1144556611", "Programador");
		vecEmpleados[2] = new Empleado("36323429","Matias","Barrientos", LocalDate.of(1991, 9, 6),
				"Masculino","r.m.barrientos@live.com","Lejos 123","1152600901","Ferroviario");
